...
q_data_dsi = RequestParserBuilder(add_pagination=True, add_slice_query=False, add_data_query=True, add_stats_query=True)
query_data_dsi_arguments = q_data_dsi.get_parser

q_data_dso = RequestParserBuilder(add_pagination=True, add_slice_query=False, add_data_query=True, add_stats_query=True, add_map_query=True, add_filter_query=True)
